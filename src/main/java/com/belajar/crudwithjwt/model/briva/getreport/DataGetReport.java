...
public class DataGetReport {
    ...
    public DataGetReport() {
    }

    public DataGetReport(String brivaNo, String custCode, String nama, String keterangan, String amount, String paymentDate, String tellerid, String no_rek) {
